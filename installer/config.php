...
$config['csrf_no_regen'] = array(); // when we need to exclude certain pages from CSRF regeneration on refresh.
// original value = array()

if (isset($_SERVER["REQUEST_URI"]) && !empty($config['csrf_no_regen'])) {
