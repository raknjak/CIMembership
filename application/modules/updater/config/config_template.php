...
*/
$config['composer_autoload'] = '%composer_autoload%';
...
|
*/
$config['permitted_uri_chars'] = '%permitted_uri_chars%';
...
|
*/
$config['allow_get_array'] = '%allow_get_array%';
...
*/
$config['log_file_permissions'] = '%log_file_permissions%';
...
|
*/
$config['error_views_path'] = '%error_views_path%';
...
|
*/
$config['cache_query_string'] = '%cache_query_string%';
...
|
*/
$config['standardize_newlines'] = '%standardize_newlines%';
...
// CUSTOM FOR CIMEMBERSHIP
$config['csrf_no_regen'] = '%csrf_no_regen%'; // when we need to exclude certain pages from CSRF regeneration on refresh.
// original value = array()

if (isset($_SERVER["REQUEST_URI"])) {
    foreach ($config['csrf_no_regen']  as $csrf_page){
