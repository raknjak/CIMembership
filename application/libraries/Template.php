 ...
 * @category		Libraries
 * @author			Philip Sturgeon - modified by Bruno Matthys in 2015
...
class Template
{
	...
	public function set_metadata($name, $content, $type = 'meta')
	{
		...
		// Keywords with no comma's? ARG! comment them
    ...
    public function add_css($line)
    {
        $this->_css[] = $line;
        return $this;
    }

    public function set_css($name, $href)
    {
        $href = htmlspecialchars(strip_tags($href));
        $this->_css[$name] = '<link href="'.$href.'" rel="stylesheet">';
        return $this;
    }
}
